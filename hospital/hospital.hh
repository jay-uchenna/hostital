...
using HosPeop = const std::vector<std::string>&;
...
public:
    ...
    void assign_staff(HosPeop hosPeop);
    ...
    void print_all_medicines(HosPeop);

    // Prints all staff recruited in hospital.
    void print_all_staff(HosPeop);
